...
enum
{
    ...
    MATRIX_INDEX_GLOBAL_MIDI_ECHO_ENABLE = 32,  //Enabling midi thru. Better not use this, communication will be messed up!
    MATRIX_INDEX_GLOBAL_MASTER_TRANSPOSE = 34,
    MATRIX_INDEX_GLOBAL_MIDI_MONO_MODE_ENABLE = 35,
    MATRIX_INDEX_GLOBAL_BEND_RANGE = 164,
    MATRIX_INDEX_GLOBAL_BANK_LOCK_ENABLE,
    MATRIX_INDEX_GLOBAL_UNISON_ENABLE = 169,
    MATRIX_INDEX_GLOBAL_VOLUME_INVERT_ENABLE,
    MATRIX_INDEX_GLOBAL_MEMORY_PROTECT_ENABLE,
};
